...
.controller('main-controller', ['$scope', '$http', '$localStorage', function ($scope, $http, $localStorage) {
  ...
  $scope.save = function() {
    ...
    $localStorage.jornada = this.jornada;
  ...
  $scope.load = function() {
    ...
    if($localStorage.jornada){
      this.jornada = $localStorage.jornada;
    };
  ...
  $scope.update = function(){
    ...
    if($scope.estrutura && $scope.classe && $scope.nivel && $scope.jornada) {
      calcular_vencimento_basico($scope);
      calcular_insalubridade($scope);
    };

    if($scope.estrutura && $scope.classe && $scope.nivel && $scope.jornada && $scope.relacao && $scope.qualificacao) {
  ...
  function calcular_vencimento_basico(scope){
    ...
    scope.vencimento_basico = scope.vencimento_basico * scope.jornada;
